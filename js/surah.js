...
if(datax==1){
    ...
    success: function (detail) {
        ...
        var htTitle = "";
            ...
            for(var i=0; i < jumlah_ayat; i++){
                ...
                htA+='<div class="mb-2">';
                htA+='<div class="col justify-content-center text-end"><div class="arab" lang="ar" style="font-size:30px;" >'+
                    ayat +'</div></div>';
    ...
    success: function (detail) {
        ...
        var htTitle = "";
            ...
            htA+='<div class="mb-2">';
            htA+='<div class="col justify-content-center text-center"><div class="arab" lang="ar" style="line-height:60px;font-size:35px;">'
                + 
                basmallah
                +'</div></div>';
            htA+='</div>';
            for(var i=0; i < jumlah_ayat; i++){
                ...
                var arti_ayat = detail['data']['verses'][i]['translation']['id'];
                htA+='<div class="mb-2">';
                htA+='<div class="col justify-content-center text-end"><div class="arab" lang="ar" style="line-height:60px;font-size:30px;" >'+ ayat +'</div></div>';
