$.ajax({
    ...
    success: function (detail) {
        ...
        for (var i = 0; i < 38; i++) {
            ...
            htA+='<a class="d-block link-surat" href="http://localhost/quran/surah.html?id='+surat_ke+'">';
        ...
        for (var i = 38; i < 76; i++) {
            ...
            htB+='<a class="d-block link-surat" href="http://localhost/quran/surah.html?id='+surat_ke+'">';
        ...
        for (var i = 76; i < 114; i++) {
            ...
            htC+='<a class="d-block link-surat" href="http://localhost/quran/surah.html?id='+surat_ke+'">';
